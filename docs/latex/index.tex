...
\end{DoxyCode}
 Note that the former places the head node in the heap with a default value of 0.\hypertarget{index_autotoc_md3}{}\doxysubsubsection{\texorpdfstring{Examples}{Examples}}\label{index_autotoc_md3}
